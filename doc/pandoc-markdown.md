...
:::  Markdown syntax/rules for pandoc converter
...
-  [Headings](#headings)
	...
	-  [ATX-style headings](#atx-style-headings)
			-  [A level-three heading ###](#a-level-three-heading)
			-  [A level-one heading with  *emphasis*](#a-level-one-heading-with-emphasis)
	-  [Heading identifiers](#heading-identifiers)
			-  [My heading {#foo}](#my-heading-foo)
			-  [My heading #####    {#foo}](#my-heading-foo)
...
-  [Non-default extensions](#non-default-extensions)
...
They are described as **Extension: xxxx ±**
You can list available extentions with ` pandoc --list-extensions=markdown `  ( + or - indicating if the extension is enabled by default )

You can download/install the latest pandoc version [here](https://github.com/jgm/pandoc/releases)
...
#### A level-one heading with  *emphasis*
...
Here <mark>mycode</mark> is an identifier, <mark>haskell</mark> and <mark>numberLines</mark> are classes, and <mark>startFrom</mark> is an attribute with value 100. 
...
**Extension: rebase_relative_paths ±**     (  Only with Pandoc version 2.14+ )
